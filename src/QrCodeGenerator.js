...
const stringToQrCode = (text, options = {}) => {
  const mergedOptions = { ...defaultOptions, ...options }
...
const stringToQrCodeSVG = (text, options = {}) => matrixToSvg(stringToQrCode(text, options), options)
export { stringToQrCode, stringToQrCodeSVG }